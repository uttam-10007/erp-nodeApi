...
router.get('/getparty:dtls', (req, res) => {
    ...
    let sql_fetchCurr = "SELECT party_pan_no,party_adhar,party_email,party_phone_no,party_local_no,id,party_id,party_leagal_name,party_gstin_no,party_type_cd,party_source_cd,create_user_id,create_timestamp,update_user_id,update_timestamp from svayam_" + b_acct_id + "_ebill.party_info"
...
router.get('/partywithphone:dtls', (req, res) => {
    ...
    let sql_fetchCurr = "SELECT party_pan_no,party_adhar,party_email,party_phone_no,party_local_no,id,party_id,party_leagal_name,party_gstin_no,party_type_cd,party_source_cd,create_user_id,create_timestamp,update_user_id,update_timestamp from svayam_" 
...
router.post('/addparty',(req,res)=>{
    ...
    let sql="insert into svayam_" + b_acct_id + "_ebill.party_info (party_pan_no,party_adhar,party_id,party_leagal_name,party_gstin_no,party_local_no,party_type_cd,party_source_cd,party_phone_no,party_email,create_user_id,create_timestamp) values "


            + "("+SqlString.escape(obj.party_pan_no)+","+SqlString.escape(obj.party_adhar)+","+SqlString.escape(obj.party_id)+","+SqlString.escape(obj.party_leagal_name)+","+SqlString.escape(obj.party_gstin_no)+","+ SqlString.escape(obj.party_local_no) +","+ SqlString.escape(obj.party_type_cd) +","+ SqlString.escape(obj.party_source_cd) +","+ SqlString.escape(obj.party_phone_no) +","+ SqlString.escape(obj.party_email) +","+SqlString.escape(obj.create_user_id)+","+create_timestamp+")"
