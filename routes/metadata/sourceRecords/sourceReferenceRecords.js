...
router.post('/createReferenceRecord', (req, res) => {
    ...
    mysqlPool.getConnection(function (error, mysqlCon) {
        if (error) {
            console.log("Error-->routes-->metadata-->sourceRecords-->sourcereferenceRecords-->--createReferenceRecord", error)
            ...
            mysqlCon.beginTransaction(function (error1) {
                if (error1) {
                    console.log("Error-->routes-->metadata-->sourceRecords-->sourcereferenceRecords-->--createReferenceRecord", error1)
                    objectToSend["error"] = true
                    objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
                    res.send(objectToSend);
                    mysqlCon.release();
                        ...
                        mysqlPool.query(sql_insert, function (error, results) {
                            if (error) {
                                ...
                                mysqlCon.query(sql_getFlds, function (error2, results2) {
                                    if (error2) {
                                        console.log("Error-->routes-->metadata-->sourceRecords-->sourcereferenceRecords-->--createReferenceRecord", error2)
                                        objectToSend["error"] = true;
                                        objectToSend["data"] = "Some error occured at server Side. Please try again later"
                                        res.send(objectToSend)
                                        mysqlCon.rollback();
                                        ...
                                        mysqlCon.query(sql_dropDb + sql_create, function (error3, results3) {
                                            if (error3) {
                                                ...
                                                console.log("Error-->routes-->metadata-->sourceRecords-->sourcereferenceRecords-->--createReferenceRecord", error3)
                                                objectToSend["error"] = true;
                                                objectToSend["data"] = "Some error occured at server Side. Please try again later"
                                                res.send(objectToSend)
                                                ...
                                                mysqlCon.commit(function (error4) {
                                                    if (error4) {
                                                        console.log("Error-->routes-->metadata-->sourceRecords-->sourcereferenceRecords-->--createReferenceRecord--", error4)
                                                        objectToSend["error"] = true
                                                        objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
                                                        res.send(objectToSend);
                                                        mysqlCon.rollback();
        ...
        if (error) {
            ...
            mysqlCon.beginTransaction(function (error12) {
                ...
                mysqlCon.query(query, function (error1, results1) {
                    if (error1) {
                        console.log("Error-->routes-->metadata-->sourceRecords-->sourceReferenceRecords-->deleteRecord-->", error1)
                        objectToSend["error"] = true;
                        objectToSend["data"] = "Some error occured at server Side. Please try again later"
                        res.send(objectToSend)
                        mysqlCon.rollback()
...
router.get('/getReferenceData:dtls', (req, res) => {
    ...
    mysqlPool.query(sql_fetchCurr, function (error, results) {
        if (error) {
            console.log("Error-->routes-->metadata-->sourceRecords-->sourceReferenceRecords-->getreferencedata--", error)
            objectToSend["error"] = true
            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
            res.send(objectToSend);
        } else {
...
router.post('/insertReferenceData', (req, res) => {
    ...
    mysqlPool.query(query, function (error, results) {
        if (error) {
            console.log("Error-->routes-->metadata-->sourceRecords-->referenceRecords-->insertReferenceData--", error)
            objectToSend["error"] = true
            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
            res.send(objectToSend);
        } else {
...
router.delete('/deleteReferenceData:dtls', (req, res) => {
    ...
    mysqlPool.query(query, function (error, results) {
        if (error) {
            console.log("Error-->routes-->metadata-->sourceRecords-->referenceRecords-->deleteReferenceData--", error)
            objectToSend["error"] = true
            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
            res.send(objectToSend);
        } else {
...
router.post('/truncateReferenceData', (req, res) => {
    ...
    mysqlPool.query(query, function (error, results) {
        if (error) {
            console.log("Error-->routes-->metadata-->sourceRecords-->referenceRecords-->truncateReferenceData--", error)
            objectToSend["error"] = true
            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
            res.send(objectToSend);
        } else {
...
router.put('/updateReferenceData', (req, res) => {
    ...
    mysqlPool.query(query, function (error, results) {
        if (error) {
            console.log("Error-->routes-->metadata-->sourceRecords-->referenceRecords-->updateReferenceData--", error)
            objectToSend["error"] = true
            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
            res.send(objectToSend);
        } else {
...
router.get('/getReferenceValues:dtls', (req, res) => {
    ...
    mysqlPool.query(query, function (error, results) {
        if (error) {
            console.log("Error-->routes-->metadata-->sourceRecords-->referenceRecords-->getReferenceData--", error)
            objectToSend["error"] = true
            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
            res.send(objectToSend);
...
router.put('/updateReferenceRecordStructure', (req, res) => {
    ...
    mysqlPool.query(sql_fetchFieldInfo, function (error, results) {
        if (error) {
            console.log("Error-->routes-->sourceRecords-->-->sourceReferenceRecords-->updateRecordStructure--", error)
            objectToSend["error"] = true
            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
            res.send(objectToSend);
        } else {
            ...
            mysqlPool.getConnection(function (error1, mysqlCon) {
                if (error1) {
                    console.log("Error-->routes-->sourceRecords-->-->sourceReferenceRecords-->updateRecordStructure--", error1)
                    objectToSend["error"] = true
                    objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
                    res.send(objectToSend);
                    ...
                    mysqlCon.beginTransaction(function (error2) {
                        if (error2) {
                            console.log("Error-->routes-->sourceRecords-->-->sourceReferenceRecords-->updateRecordStructure--", error2)
                            objectToSend["error"] = true
                            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
                            res.send(objectToSend);
                            mysqlCon.release()
                            ...
                            mysqlCon.query(mainQuery, function (error3, results3) {
                                if (error3) {
                                    console.log("Error-->routes-->sourceRecords-->-->sourceReferenceRecords-->updateRecordStructure--", error3)
                                    objectToSend["error"] = true
                                    objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
                                    res.send(objectToSend);
                                    mysqlCon.rollback()
                                    ...
                                    if (isColAdded ||isColDeleted) {
                                        ...
                                        mysqlCon.commit(function (error4) {
                                            if (error4) {
                                                console.log("Error-->routes-->sourceRecords-->-->sourceReferenceRecords-->updateRecordStructure--", error4)
                                                objectToSend["error"] = true
                                                objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
                                                res.send(objectToSend);
                                                mysqlCon.release()
