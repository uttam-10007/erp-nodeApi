...
router.post('/createExtension', (req, res) => {
    let obj = req.body
    let objectToSend = {}
    ...
    let sql = "insert into " + db + ".record_info (record_code,record_business_name,record_technical_name,domain_code,record_type,parent_record_code,status) values "
        ...
        + SqlString.escape(obj.domain_code) + ",'extension'," + SqlString.escape(obj.parent_record_code) + ",0);"

    mysqlPool.getConnection(function (error, mysqlCon) {
        if (error) {
            console.log("Error-->routes-->metadata-->fpem-->extension-->createExtension--", error)
            ...
            mysqlCon.beginTransaction(function (error1) {
                if (error1) {
                    console.log("Error-->routes-->metadata-->fpem-->extension-->createExtension--", error1)
                    objectToSend["error"] = true
                    objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
                    res.send(objectToSend);
                    mysqlCon.release();
                    ...
                    mysqlCon.query(sql, function (error2, results2) {
                        if (error2) {
                            console.log("Error-->routes-->metadata-->fpem-->extension-->createExtension--", error2)
                            objectToSend["error"] = true;
                            ...
                            mysqlCon.query(xrefQuery+";"+sql_dropTable+";"+createQuery, function (error3, results2) {
                                if (error3) {
                                    console.log("Error-->routes-->metadata-->fpem-->extension-->createExtension--", error3)
                                    objectToSend["error"] = true;
                                    objectToSend["data"] = "Some error occured at server Side. Please try again later"
                                    res.send(objectToSend)
                                    mysqlCon.rollback();
                                    ...
                                    mysqlCon.query('COMMIT', function (error4) {
                                        if (error4) {
                                            console.log("Error-->routes-->metadata-->fpem-->extension-->createExtension--", error4)
                                            objectToSend["error"] = true;
                                            objectToSend["data"] = "Some error occured at server Side. Please try again later"
                                            res.send(objectToSend)
                                            mysqlCon.rollback();
                                            ...
                                            objectToSend["data"] = "Extension Created Successfully!"
                                            res.send(objectToSend)
                                        }
...
router.delete('/deleteExtension:dtls', (req, res) => {
    ...
    mysqlPool.getConnection(function (error, mysqlCon) {
        if (error) {
            console.log("Error-->routes-->metadata-->fpem-->extension-->deleteExtension--", error)
            objectToSend["error"] = true
            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
            res.send(objectToSend);
        } else {
            mysqlCon.beginTransaction(function (error1) {
                if (error1) {
                    console.log("Error-->routes-->metadata-->fpem-->extension-->deleteExtension--", error1)
                    objectToSend["error"] = true
                    objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
                    res.send(objectToSend);
                    mysqlCon.release();
                    ...
                    mysqlCon.query(sql+";"+xrefDel, function (error2, results2) {
                        if (error2) {
                            console.log("Error-->routes-->metadata-->fpem-->extension-->deleteExtension--", error2)
                            objectToSend["error"] = true;
                            objectToSend["data"] = "Some error occured at server Side. Please try again later"
                            res.send(objectToSend)
                            mysqlCon.rollback();
                            ...
                            mysqlCon.query(sql_dropTable, function (error3, results3) {
                                if (error3) {
                                    console.log("Error-->routes-->metadata-->fpem-->extension-->deleteExtension--", error3)
                                    objectToSend["error"] = true;
                                    objectToSend["data"] = "Some error occured at server Side. Please try again later"
                                    res.send(objectToSend)
                                    mysqlCon.rollback();
                                    ...
                                    mysqlCon.query('COMMIT', function (error4) {
                                        if (error4) {
                                            console.log("Error-->routes-->metadata-->fpem-->extension-->deleteExtension--", error4)
                                            objectToSend["error"] = true;
                                            objectToSend["data"] = "Some error occured at server Side. Please try again later"
                                            res.send(objectToSend)
                                            mysqlCon.rollback();
                                            ...
                                            objectToSend["error"] = false;
                                            objectToSend["data"] = "Extension Deleted Successfully!"
                                            res.send(objectToSend)
                                        }
...
router.get('/getextension:dtls', (req, res) => {
    ...
    +" where r.record_type='extension' group by r.record_code,r.record_business_name,r.record_technical_name,r.domain_code,r.record_type,r.parent_record_code,r.`status`"

    mysqlPool.query(sql_fetchCurr, function (error, results) {
        if (error) {
            console.log("Error-->routes-->metadata-->fpem-->extension-->getextension--", error)
            objectToSend["error"] = true
            objectToSend["data"] = "Some error occured at server side. Please try again later. If problem persists, contact support."
            res.send(objectToSend);
        } else {
