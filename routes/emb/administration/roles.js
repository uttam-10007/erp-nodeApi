...
let sql="SELECT ui.*,da.role_cd,da.zone_cd FROM (SELECT * from "+propObj.svayamSystemDbName
            +".user_info WHERE b_acct_id="+obj.b_acct_id+") ui JOIN "+db+".data_auth da "
                +" ON da.user_id=ui.user_id WHERE da.zone_cd="+SqlString.escape(obj.zone_cd)
...
router.get('/getRoles:dtls',(req,res)=>{
    let objectToSend={}
